(function($) {
  ...
  ConditionsBuilder.prototype = {
    ...
    buildConditional: function(ruleData) {
      ...
      selectWrapper.append($("<strong>", {text: "If"})); // rules
      ...
      selectWrapper.append($("<strong>", {text: "of the following conditions are met:"})); // rules
      div.append(selectWrapper);

      
      /*
      var addRuleLink = $("<a>", {"href": "#", "class": "add-rule", "text": "Add Condition"}); // Add Rule
      var _this = this;
    ...
    buildRule: function(ruleData) {
      ...
      var ruleDiv = $("<div>", {"class": "rule " + (!this.firstRule ? "first-item" : "") });
      ...
      var addRuleLink = $("<a>", {"href": "#", "class": "add-rule", "text": "Add condition", "title" : "Add another condition to this rule"}); // Add Rule
      var _this = this;
      addRuleLink.click(function(e) {
        e.preventDefault();
        var f = _this.fields[0];
        var newField = {name: f.value, operator: f.operators[0], value: null};
        $(this).parent(".rule").after(_this.buildRule(newField));
      });
      ruleDiv.append(addRuleLink);
  ...
  function removeLink() {
    var removeLink = $("<a>", {"class": "remove remove-condition", "href": "#", "text": "Remove", "title" : "Remove this condition from this rule"});
