    ...
    $.fn.extend({
    	menuButton: function (o) {
        	...
        	var init = function() {
        		...
        		var buttonContainer = $("<div class=\"ui-button-dropdown\"></div>").appendTo(a);
        		//var lastCombo = null;
                ...
                */
        		...
        		var drop = $("<button class=\"button-" + (options.color != undefined ? options.color : "white") + "\" title=\"" + options.label + "\"><span>" + options.label + "</span><i class=\"icon-more\">&nbsp;</i></button>")
        		.click(function() {
