	...
	<div>
		<div style="float: left; width: 220px;">
			<ul class="side-navigation-tabs">
				...
				<li class="active"><a href="<%=absoluteURL %>/templates/forms/mailing-list" title="Forms">Forms</a></li>
		...
		<div style="float: left; width: 220px; padding-left: 10px;">
			<ul class="side-navigation-tabs">
				...
				<li class="active"><a href="<%=absoluteURL %>/templates/forms/mailing-list" title="Mailing List">Mailing List</a></li>
			</ul>
		</div>
		<div style="float: left; width: 450px; padding-left: 10px;">
			Mailing List
			<div><a href="<%=applicationURL %>/servlet/opinions?guid=94e65d92-9c85-471b-b910-fbbc4c2488bf&name=Join our Mailing List" title="Use this Template" class="button-white"><span>Use this Template</span></a></div>
			<div style="border: 1px solid #ccc; min-height: 300px; margin: 10px 0">
			    ...
			    $(function() {
			    	var iframe = $("<iframe style=\"border: none; height:100%; width:100%\" frameborder=\"0\" allowtransparency=\"true\" />").appendTo("#template_preview").on("load",function(){
						...
						_inq.push({
							guid : "94e65d92-9c85-471b-b910-fbbc4c2488bf",
