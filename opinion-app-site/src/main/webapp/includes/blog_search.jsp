...
<div>
	<div class="wrapper-content-left">
		<%
			OperationResult<List<IPost>> searchResult = BlogManager.searchPosts(null, null, null, searchWord, 100, Blogs.OfficialInqwiseBlog);
			if(!searchResult.hasError()){
				List<IPost> posts = searchResult.getValue();
		...
		%>
					...
					<%
												...
												if(null != searchWord) {
										%>
					Your search for <b>"<%=searchWord%>"</b> returned no matches.
					<%
											}
											}
										%>
...
%>
	...
	<div class="wrapper-content-right">
		...
		<div style="padding: 12px 0 24px 8px;">
			<div class="row">
				<div class="cell">
					<input id="input_search" type="text" class="text-field" style="width: 144px;" onkeydown="catchSearch(event)" placeholder="Search this Blog" />
				</div>
