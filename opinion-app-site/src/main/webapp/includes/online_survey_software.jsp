...
<div>
	<div class="promo-1">
		<div class="container" style="padding-top: 0px; padding-bottom: 24px;">
			<h2>Online Survey Software <br/>That Makes It Easy.</h2>
			<p>Create online surveys - fast, easy, and free.</p>
			<a href="<%=absoluteURL %>/register?ref=online-survey-software" title="Sign Up" class="button-yellow"><span>Sign Up</span></a>
		</div>
	</div>
