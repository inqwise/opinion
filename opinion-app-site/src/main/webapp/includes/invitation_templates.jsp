	...
	<div>
		<div style="float: left; width: 220px;">
			<ul class="side-navigation-tabs">
				...
				<li class="active"><a href="<%=absoluteURL %>/templates/invitations/birthday-party" title="Invitations">Invitations</a></li>
		...
		<div style="float: left; width: 220px; padding-left: 10px;">
			<ul class="side-navigation-tabs">
				<li class="active"><a href="<%=absoluteURL %>/templates/invitations/birthday-party" title="Birthday Party">Birthday Party</a></li>
			</ul>
		</div>
		<div style="float: left; width: 450px; padding-left: 10px;">
			Birthday Party
			<div><a href="<%=applicationURL %>/servlet/opinions?guid=aef60090-4f0a-4857-bbe9-74ad61d838d0&name=You're Invited to a Birthday Party!" title="Use this Template" class="button-white"><span>Use this Template</span></a></div>
			<div style="border: 1px solid #ccc; min-height: 300px; margin: 10px 0">
			    ...
			    $(function() {
			    	var iframe = $("<iframe style=\"border: none; height:100%; width:100%\" frameborder=\"0\" allowtransparency=\"true\" />").appendTo("#template_preview").on("load",function(){
						...
						_inq.push({
							guid : "aef60090-4f0a-4857-bbe9-74ad61d838d0",
