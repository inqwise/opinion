	...
	<div>
		<div style="float: left; width: 220px;">
			<ul class="side-navigation-tabs">
				<li class="active"><a href="<%=absoluteURL %>/templates/surveys/customer-satisfaction-survey" title="Surveys">Surveys</a></li>
		...
		<div style="float: left; width: 220px; padding-left: 10px;">
			<ul class="side-navigation-tabs">
				<li class="active"><a href="<%=absoluteURL %>/templates/surveys/customer-satisfaction-survey" title="Customer Satisfaction Survey">Customer Satisfaction Survey</a></li>
				<li><a href="<%=absoluteURL %>/templates/surveys/cancellation-survey" title="Cancellation Survey">Cancellation Survey</a></li>
			</ul>
		</div>
		<div style="float: left; width: 450px; padding-left: 10px;">
			Customer Satisfaction Survey
			<div><a href="<%=applicationURL %>/servlet/opinions?guid=d3e79590-ab8b-4e00-86e9-2c27affd7406&name=Customer Satisfaction Survey" title="Use this Template" class="button-white"><span>Use this Template</span></a></div>
			<div style="border: 1px solid #ccc; min-height: 300px; margin: 10px 0">
			    ...
			    $(function() {
			    	var iframe = $("<iframe style=\"border: none; height:100%; width:100%\" frameborder=\"0\" allowtransparency=\"true\" />").appendTo("#template_preview").on("load",function(){
						...
						_inq.push({
							guid : "d3e79590-ab8b-4e00-86e9-2c27affd7406",
