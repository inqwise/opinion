	...
	<div>
		<div style="float: left; width: 220px;">
			<ul class="side-navigation-tabs">
				...
				<li class="active"><a href="<%=absoluteURL %>/templates/registrations/retreat-registration" title="Registrations">Registrations</a></li>
		...
		<div style="float: left; width: 220px; padding-left: 10px;">
			<ul class="side-navigation-tabs">
				<li class="active"><a href="<%=absoluteURL %>/templates/registrations/retreat-registration" title="Retreat Registration">Retreat Registration</a></li>
			</ul>
		</div>
		<div style="float: left; width: 450px; padding-left: 10px;">
			
			Retreat Registration
			<div><a href="<%=applicationURL %>/servlet/opinions?guid=48691203-1888-4d98-9f2d-4fadccbe22bf&name=Retreat Registration" title="Use this Template" class="button-white"><span>Use this Template</span></a></div>
			<div style="border: 1px solid #ccc; min-height: 300px; margin: 10px 0">
			    ...
			    $(function() {
			    	var iframe = $("<iframe style=\"border: none; height:100%; width:100%\" frameborder=\"0\" allowtransparency=\"true\" />").appendTo("#template_preview").on("load",function(){
						...
						_inq.push({
							guid : "48691203-1888-4d98-9f2d-4fadccbe22bf",
