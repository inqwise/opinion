...
<h1>
	...
	%>
				<a href="<%=absoluteURL%>/blog/categories" title="Categories">Categories</a>&nbsp;&rsaquo;&nbsp;<%=categoryName%>
			<%
				} else {
			%>
				<%=p.getHeader()%>
	...
	<div class="wrapper-content-left">
		<%
			if(null != categoryName) {
				...
				OperationResult<List<IPost>> postsResult = BlogManager.searchPosts(null, categoryName, null, null, 100, Blogs.OfficialInqwiseBlog);
		...
		%>
						...
						<%
												...
												%>
							<a href="<%=absoluteURL%>/blog/categories/<%=URLEncoder.encode(category.getName(), "UTF-8")%>" title="<%=category.getName()%>"><%=category.getName()%></a>
						<%
							}
								}
