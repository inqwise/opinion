		...
		<div class="content-middle-tabs-section">
			<div class="content-middle-tabs">
				<ul class="content-middle-tabs-container">
					...
					<li><a href="<%=absoluteURL %>/account-polls?account_id=<%=accountId %>" title="Polls" class="selected"><span>Polls</span></a></li>
					...
					<!-- <li><a href="<%=absoluteURL %>/account-notes?account_id=<%=accountId %>" title="Notes"><span>Notes</span></a></li> -->
				</ul>
			</div>
...
var renderTablePolls = function() {
	...
	tablePolls = $('#table_polls').dataTable({
		tableColumns : [
			...
			{ key: 'started', label: 'Responses', sortable: true, sortBy : { key : 'started', dataType: "number" }, width: 74, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } } },
			{ key: 'completed', label: 'Completed', sortable: true, sortBy : { key : 'completed', dataType: "number" }, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } }, width: 74 },
			{ key: 'partial', label: 'Partial', sortable: true, sortBy : { key : 'partial', dataType: "number" }, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } }, width: 50 },
			{ key : 'completionRate', label : 'Completion Rate', sortable : true, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } }, width: 110, formatter: function(cell, value, record, source) {
