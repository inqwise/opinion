		...
		<div class="content-middle-tabs-section">
			<div class="content-middle-tabs">
				<ul class="content-middle-tabs-container">
					...
					<li><a href="<%=absoluteURL %>/account-history?account_id=<%=accountId %>" title="History" class="selected"><span>History</span></a></li>
				</ul>
			</div>
	...
	//	success : function(data) {			
			tableHistory = $('#table_history').dataTable({
				tableColumns : [
					...
					{ key : 'operationType', label : 'Operation Type', sortable : true, width: 160 },
