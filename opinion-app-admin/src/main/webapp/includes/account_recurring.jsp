...
<div>
		...
		<div class="content-middle-tabs-section">
			<div class="content-middle-tabs">
				<ul class="content-middle-tabs-container">
					...
					<li><a href="<%=absoluteURL %>/account-recurring?account_id=<%=accountId %>" title="Recurring" class="selected"><span>Recurring</span></a></li>
	...
	<div style="clear: both; padding-top: 20px;">
		<div id="table_recurring_charges"></div>
	</div>
</div>
...
// { chargeId : 1, nextDate : "May 09, 2013 00:00:00", chargeName : "Miscellaneous** - PRO Plan $24.00", amount : "$288.00", isTaxable : false, cycle : "Annually 12/12" }
var tableRecurringCharges = null;
$(function() {
	...
	//getUsers({
	//	success : function(data) {			
			tableRecurringCharges = $('#table_recurring_charges').dataTable({
				tableColumns : [
					{ key : 'chargeId', label : '#', sortable: true, width: 46, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } } },
					{ key : 'nextDate', label : 'Next Date', sortable: true, sortBy : { dataType: "date" }, width: 124, formatter: function(cell, value, record, source) {
						if(record.nextDate) {
							var left = record.nextDate.substring(record.nextDate.lastIndexOf(" "), " ");
							return left;
						} 
		            }},
					{ key : 'chargeName', label : 'Charge Name', sortable : true, formatter : function(cell, value, record, source) {
						return $("<a href=\"<%=absoluteURL %>/charge-details?user_id=" + record.chargeId  + "\" title=\"" + record.chargeName + "\">" + record.chargeName + "</a>");
					}},
					{ key : 'amount', label : 'Amount', sortable: true, width: 74, style : { header: { 'text-align' : 'right' }, cell : { 'text-align' : 'right' } } },
					{ key : 'isTaxable', label : 'Taxable', sortable: true, width: 60, formatter : function(cell, value, record, source) {
						return record.isTaxable ? "Yes" : "No";
					}},
					{ key : 'cycle', label : 'Cycle', sortable: true, width: 160 }
				],
				dataSource : [], 
				pagingStart : 10,
				show : [5, 10, 25, 50, 100],
