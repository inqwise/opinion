...
<%
	...
	String opinionType = request.getParameter("opinion_type");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title></title>
		<meta name="description" content="Create free online surveys in minutes with our easy to use online survey tool. Try our survey tool for free." />
		<meta name="keywords" content="online survey tool, online survey tools, on line survey tools, free survey tool, online survey, online surveys, online survey software" />
	...
	<body>
		...
		<script type="text/javascript" src="<%=staticUrl%>/scripts/widget/1.1.2/survey.js">
		{
			"embed" : false,
			"noStyle" : <%=noStyle %>,
		    "guid" : "<%=guid%>",
		    ...
		    "modeId" : <%= (respondent != null && respondent.equals("reviewer")) ? 0 : modeId %>,
		    "respondent" : "<%= (respondent != null ? respondent : "") %>",
		    "themeId" : <%=themeId%>,
		    "url" : "<%=applicationURL%>/c/1/<%=guid%>/1",
		    "analytics" : <%=ApplicationConfiguration.General.isEnableGoogleAnalytics()%>
		}
		</script>
		<noscript>
			<p><a href="<%=applicationURL%>/c/1/<%=guid%>/1">Online Survey @ Inqwise.com</a></p>
		    <p><a href="http://www.inqwise.com" title="Online Survey Tool" target="_blank">Online Surveys</a> by Inqwise</p>
		</noscript>
