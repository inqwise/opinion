    ...
    lightFace = function (a) {
        ...
        var j = function () {
            if (options.overlayAll) {
                ...
                if(options.enableOverlayClose) {
	                g.click(function () {
	                    if (options.abort != undefined && typeof options.abort == 'function') {
	                        options.abort();
	                    }
	                    l()
	                });
            ...
            if(options.width != "auto") {
            	$(".lightface-content").css({ "width" : options.width });
            }
            
            if(options.height != "auto") {
            	$(".lightface-content").css({ "height" : options.height });
            	
            	var outerHeight = $(".lightface-title:visible").outerHeight() + $(".lightface-actions:visible").outerHeight() + 20;
            	$(".lightface-message")
            	.css({ "height" : options.height - outerHeight })
            	.scrollTop(0);
            }
