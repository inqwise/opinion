    ...
    validator = function (s) {
        ...
        var R = function (a) {
            for (var i = 0; i < O.length; i++) {
                if (O[i].element) {
                    if (O[i].element.attr('name') == a.attr('name')) {
                        return O[i]
                    }
                }
            }
        ...
        if (O.length > 0) {
            for (var i = 0; i < O.length; i++) {
                if (O[i].name) {
                    ...
                    var V = T(U);
                    O[i].element = $(V);
                    O[i].element.validateDelegate(":text, :password, :file, select, textarea", "focusin focusout keyup", function (a) {
                        bg($(this), a.type)
                    ...
                    var W = null;
                    if (D.errorTemplate) {
                        W = D.errorTemplate().addClass('status validator-' + U).hide()
                    } else {
                        W = $("<label class=\"status validator-" + U + "\" style=\"display: none\"></label>")
                    }
                    if (D.errorList) {
                        if (D.errorList.placeholder) {
                            if (!H(U)) {
                                if (D.errorList.errorTemplate) {
                                    ...
                                    W.appendTo(D.errorList.placeholder)
                                }
                            }
                        }
                    } else {
                ...
                if (O[i].group) {
                    ...
                    O[i].group.each(function (y, c) {
                        ...
                        $(c).validateDelegate(":text, :password, :file, select, textarea", "focusin focusout keyup", function (a) {
                    ...
                    var W = null;
                    if (D.errorTemplate) {
                        W = D.errorTemplate().addClass('status validator-' + X).hide()
                    } else {
                        W = $("<label class=\"status validator-" + X + "\" style=\"display: none\"></label>")
                    }
                    if (D.errorList) {
                        if (D.errorList.placeholder) {
                            if (D.errorList.errorTemplate) {
                                D.errorList.errorTemplate().addClass('status validator-' + X).hide().appendTo(D.errorList.placeholder)
                            } else {
                                W.appendTo(D.errorList.placeholder)
                            }
                        }
                        ...
                        if (O[i].status) {
                            O[i].status.addClass('status validator-' + X).hide()
                        } else {
                            if (O[i].showError != undefined) {
                                if (O[i].showError) {
                                    Y.after(W)
        ...
        if (D.submitElement != undefined) {
            D.submitElement.click(function () {
                bh()
            })
        }
        var bh = function (a) {
            ...
            if (B.length != 0) {
                ...
                if (a) {
                    if (a.error != undefined && typeof a.error == 'function') a.error()
                }
            }
            ...
            if (a) {
                if (a.accept != undefined && typeof a.accept == 'function') {
                    if (x.length == 0) a.accept()
                }
            }
        };
        return {
